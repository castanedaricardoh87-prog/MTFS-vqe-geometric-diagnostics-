...
> **Scope note**  
> This is a numerical test of the discrete soft-Hamiltonian engine on a parameterized proxy. It does **not** constitute a first-principles, force-field, or crystallographic simulation of real zircon (ZrSiO₄). See the Limitations section for details.
